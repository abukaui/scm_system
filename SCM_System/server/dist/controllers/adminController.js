...
exports.registerAdmin = exports.getComplaintById = exports.getAllStudents = exports.updateComplaintStatus = exports.getAllComplaints = exports.loginAdmin = void 0;
...
const registerAdmin = async (req, res) => {
    try {
        ...
        const result = await config_1.pool.query("INSERT INTO users (name, email, password, role) VALUES ($1, $2, $3, 'admin') RETURNING id, name, email, role", [name, email, hashedPassword]);
