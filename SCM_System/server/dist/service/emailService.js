...
exports.sendPasswordResetEmail = exports.sendWelcomeEmail = exports.getFrontendUrl = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const requiredSmtpEnv = ['SMTP_HOST', 'SMTP_USER', 'SMTP_PASS'];
...
const createTransporter = async () => {
    ...
    try {
        ...
        if (isProd)
            console.log('🔄 Verifying SMTP transporter for production...');
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div style="text-align: center;">
                                <a href="${(0, exports.getFrontendUrl)()}/login" class="btn">Explore My Dashboard</a>
                            </div>
                        </div>
                        <div class="footer">
